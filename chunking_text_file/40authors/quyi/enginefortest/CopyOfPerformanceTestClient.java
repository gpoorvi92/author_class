...
public class CopyOfPerformanceTestClient {
	...
	public static void main(String[] args) {
		 ...
		 * Workbook.createWorkbook(new File("E:\\病毒应用信息.xls")); WritableSheet
		 * sheet = workbook.createSheet("Sheet1", 0); Cell cell0 =
		 * sheet.findLabelCell("0012f02ebe3642c1ca5a82f7e737559c"); Cell cell =
		 * sheet.findCell("0012f02ebe3642c1ca5a82f7e737559c"); int row =
...
//		autoissueMessages("D:\\6月6日测试文档\\病毒批次下发问题应用.xls", 7, 35*60000, 7, 4);
//		autoissueMessages("D:\\6月6日测试文档\\病毒批次下发问题应用.xls", 13, 13*5*60000, 13, 5);
//		autoissueMessages("D:\\6月6日测试文档\\病毒批次下发问题应用.xls", 19, 19*5*60000, 19, 6);
	//	autoissueMessages("D:\\6月6日测试文档\\病毒批次下发问题应用.xls", 100, 450*60000, 400, 7);
		// new Thread(new
		// SearchRecordInfoConsumer("D:\\6月6日测试文档\\测试查询应用.xls")).start();
		// autoSearchApp("D:\\6月6日测试文档\\单个应用下发统计.xls");
		//new Thread(new SearchRecordInfoConsumer("D:\\6月6日测试文档\\测试查询单个引擎.xls")).start();
		//autoSearchApp("D:\\6月6日测试文档\\单个应用下发统计.xls");
		//searchEngine(10, 1000);
		//searchEngine(20, 1000);
		//searchEngine(50, 1000);
		///searchEngine(100, 1000);
		//new Thread(new SearchRecordInfoConsumer("D:\\6月6日测试文档\\测试查询全部引擎.xls")).start();
		//searchAllEngine(100,5000);
		//searchAllEngine(200,5000);
		//searchAllEngine(500,5000);
	...
	public static void autoissueMessages(String filePath, int missionSize, long waitTime, int issueAppSize, int sheetNum) {
		...
		for (int missionId = 0; missionId < appInfoList.size() / missionSize; missionId++) {
			String realMissionId = "Multi200NoVirus" + String.valueOf(missionSize) + "@" + String.valueOf(missionId);
