...
public class BananaSplitInfo extends JFrame implements ActionListener
{
	...
	private ImageIcon ABC=new ImageIcon("desert/banana split.jpeg");
	private JButton jbtBack =new JButton("Back");

    public BananaSplitInfo() 
    {
    	...
    	public static void main(String[] args)
	{
		...
		frame.setTitle("BananaSplit Info");
